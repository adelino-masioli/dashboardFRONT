...
import SchooltransferForm from './schooltransferForm';
...
class SchoolTransfer extends Component {
	constructor(props) {
		super(props);
	...
	render() {
		...
		return (
			<div>
				<ContentHeader>
					<ContentHeaderTitle title={nameSchool} small='Transfer'/>
					<ContentHeaderBreadcrumb>
						<ContentHeaderBreadcrumbItem path='#/' icon='home' label='Home'/>
						<ContentHeaderBreadcrumbItem active='active'  label={`${nameSchool} Transfer`}/>
					</ContentHeaderBreadcrumb>
				</ContentHeader>
					...
					<Tabs>
						...
						<TabsContent>
							<TabContent id='tabCreate'>
								<SchooltransferForm onSubmit={this.props.create} submitClass='primary' submitLabel='Create' dataProps={params.schoolid}/>
							</TabContent>
							<TabContent id='tabUpdate'>
								<SchooltransferForm onSubmit={this.props.update} submitClass='info' submitLabel='Update' dataProps={params.schoolid} dataPropsId={params.id}/>
							</TabContent>
							<TabContent id='tabDelete'>
								<SchooltransferForm onSubmit={this.props.remove}  readOnly={true} submitClass='danger' submitLabel='Destroy' dataProps={params.schoolid} dataPropsId={params.id}/>
							</TabContent>
						</TabsContent>
					</Tabs>
				</Content>
...
export default connect(null, mapDispatchToProps)(SchoolTransfer);
