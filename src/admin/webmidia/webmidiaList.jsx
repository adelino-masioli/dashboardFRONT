...
import { getList, showUpdate, showDelete } from './webmidiaActions';
import NoResult from '../../common/template/noResult';
import LoadingPage from '../../common/loading/loading';

class WebmidiaList extends Component {
	constructor(props) {
		super(props);
		this.state = {
            wating: true
...
const mapStateToProps = state => ({list: state.webmidia.list});
const mapDispatchToProps = dispatch => bindActionCreators({getList, showUpdate, showDelete}, dispatch);
export default connect(mapStateToProps, mapDispatchToProps)(WebmidiaList);
