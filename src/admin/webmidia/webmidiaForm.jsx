...
import { init } from './webmidiaActions';

class WebmidiaForm extends Component {
...
WebmidiaForm = reduxForm({form: 'webmidiaForm', destroyOnUnmount: false})(WebmidiaForm);
const mapDispatchToProps = dispatch => bindActionCreators({
	init
}, dispatch);
export default connect(null, mapDispatchToProps)(WebmidiaForm);
