...
import { create, update, remove } from './companyActions';
...
class Company extends Component {
	...
	render() {
		...
		return (
			<div>
				<ContentHeader>
					<ContentHeaderTitle title='Companies' small='Registers'/>
					<ContentHeaderBreadcrumb>
						<ContentHeaderBreadcrumbItem path='#/' icon='home' label='Home'/>
						<ContentHeaderBreadcrumbItem active='active'  label='Companies'/>
					</ContentHeaderBreadcrumb>
				</ContentHeader>
					...
					<Tabs>
						...
						<TabsContent>
							...
							<TabContent id='tabCreate'>
								<CompanyForm onSubmit={this.props.create} submitClass='primary' submitLabel='Create'/>
							</TabContent>
							<TabContent id='tabUpdate'>
								<CompanyForm onSubmit={this.props.update} submitClass='info' submitLabel='Update' dataProps={params.id}/>
							</TabContent>
							<TabContent id='tabDelete'>
								<CompanyForm onSubmit={this.props.remove}  readOnly={true} submitClass='danger' submitLabel='Destroy'/>
							</TabContent>
						</TabsContent>
					</Tabs>
				</Content>
