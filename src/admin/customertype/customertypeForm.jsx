...
import { init } from './customertypeActions';
...
CustomertypeForm = reduxForm({form: 'customertypeForm', destroyOnUnmount: false})(CustomertypeForm);
const mapDispatchToProps = dispatch => bindActionCreators({
	init
}, dispatch);
export default connect(null, mapDispatchToProps)(CustomertypeForm);
