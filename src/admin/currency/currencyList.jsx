...
import { getList, showUpdate, showDelete } from './currencyActions';
...
class CurrencyList extends Component {
	...
	renderHeader(){
		const headerTitle = ['ID', 'NAME', 'CODE', 'SYMBOL',  'DECIMAL PLACES', 'ACTIONS'];
...
const mapStateToProps = state => ({list: state.currency.list});
