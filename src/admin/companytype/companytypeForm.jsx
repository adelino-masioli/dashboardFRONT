...
import { init } from './companytypeActions';
...
CompanytypeForm = reduxForm({form: 'companytypeForm', destroyOnUnmount: false})(CompanytypeForm);
const mapDispatchToProps = dispatch => bindActionCreators({
	init
}, dispatch);
export default connect(null, mapDispatchToProps)(CompanytypeForm);
