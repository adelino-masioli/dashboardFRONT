...
import { init } from './feetypeActions';
...
FeetypeForm = reduxForm({form: 'feetypeForm', destroyOnUnmount: false})(FeetypeForm);
const mapDispatchToProps = dispatch => bindActionCreators({
	init
}, dispatch);
export default connect(null, mapDispatchToProps)(FeetypeForm);
