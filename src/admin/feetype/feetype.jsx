...
import { create, update, remove } from './feetypeActions';
...
class Feetype extends Component {
	...
	render() {
		...
		return (
			<div>
				<ContentHeader>
					<ContentHeaderTitle title='Fee Types' small='Registers'/>
					<ContentHeaderBreadcrumb>
						<ContentHeaderBreadcrumbItem path='#/' icon='home' label='Home'/>
						<ContentHeaderBreadcrumbItem active='active'  label='Fee Types'/>
					</ContentHeaderBreadcrumb>
				</ContentHeader>
					...
					<Tabs>
						...
						<TabsContent>
							...
							<TabContent id='tabCreate'>
								<FeetypeForm onSubmit={this.props.create} submitClass='primary' submitLabel='Create'/>
							</TabContent>
							<TabContent id='tabUpdate'>
								<FeetypeForm onSubmit={this.props.update} submitClass='info' submitLabel='Update' dataProps={params.id}/>
							</TabContent>
							<TabContent id='tabDelete'>
								<FeetypeForm onSubmit={this.props.remove}  readOnly={true} submitClass='danger' submitLabel='Destroy'/>
							</TabContent>
						</TabsContent>
					</Tabs>
				</Content>
...
export default connect(null, mapDispatchToProps)(Feetype);
