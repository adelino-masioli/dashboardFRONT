...
import { getList, showUpdate, showDelete } from './feetypeActions';
...
const mapStateToProps = state => ({list: state.feetype.list});
const mapDispatchToProps = dispatch => bindActionCreators({getList, showUpdate, showDelete}, dispatch);
export default connect(mapStateToProps, mapDispatchToProps)(FeetypeList);
