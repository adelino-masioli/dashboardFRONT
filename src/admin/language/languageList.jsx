...
import { getList, showUpdate, showDelete } from './languageActions';
...
class LanguageList extends Component {
	...
	renderHeader(){
		const headerTitle = ['ID', 'NAME', 'SHORT NAME', 'ACTIONS'];
...
const mapStateToProps = state => ({list: state.language.list});
