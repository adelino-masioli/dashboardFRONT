...
import { getList, showUpdate, showDelete } from './accommodationtypeActions';
import NoResult from '../../common/template/noResult';
import LoadingPage from '../../common/loading/loading';

class AccommodationtypeList extends Component {
	constructor(props) {
		super(props);
		this.state = {
            wating: true
...
const mapStateToProps = state => ({list: state.accommodationtype.list});
const mapDispatchToProps = dispatch => bindActionCreators({getList, showUpdate, showDelete}, dispatch);
export default connect(mapStateToProps, mapDispatchToProps)(AccommodationtypeList);
