...
import CustomerstatusList from './customerstatusList';
import CustomerstatusForm from './customerstatusForm';
import { create, update, remove } from './customerstatusActions';
					...
					<Tabs>
						...
						<TabsContent>
							...
							<TabContent id='tabCreate'>
								<CustomerstatusForm onSubmit={this.props.create} submitClass='primary' submitLabel='Create'/>
							</TabContent>
							<TabContent id='tabUpdate'>
								<CustomerstatusForm onSubmit={this.props.update} submitClass='info' submitLabel='Update' dataProps={params.id}/>
							</TabContent>
							<TabContent id='tabDelete'>
								<CustomerstatusForm onSubmit={this.props.remove}  readOnly={true} submitClass='danger' submitLabel='Destroy'/>
							</TabContent>
						</TabsContent>
					</Tabs>
				</Content>
...
export default connect(null, mapDispatchToProps)(Customerstatus);
