...
import SchoolaccommodationForm from './schoolaccommodationForm';
...
class SchoolAccommodation extends Component {
	constructor(props) {
		super(props);
	...
	render() {
		...
		return (
			<div>
				<ContentHeader>
					<ContentHeaderTitle title={nameSchool} small='Accommodation'/>
					<ContentHeaderBreadcrumb>
						<ContentHeaderBreadcrumbItem path='#/' icon='home' label='Home'/>
						<ContentHeaderBreadcrumbItem active='active'  label={`${nameSchool} Accommodation`}/>
					</ContentHeaderBreadcrumb>
				</ContentHeader>
					...
					<Tabs>
						...
						<TabsContent>
							<TabContent id='tabCreate'>
								<SchoolaccommodationForm onSubmit={this.props.create} submitClass='primary' submitLabel='Create' dataProps={params.schoolid}/>
							</TabContent>
							<TabContent id='tabUpdate'>
								<SchoolaccommodationForm onSubmit={this.props.update} submitClass='info' submitLabel='Update' dataProps={params.schoolid} dataPropsId={params.id}/>
							</TabContent>
							<TabContent id='tabDelete'>
								<SchoolaccommodationForm onSubmit={this.props.remove}  readOnly={true} submitClass='danger' submitLabel='Destroy' dataProps={params.schoolid} dataPropsId={params.id}/>
							</TabContent>
						</TabsContent>
					</Tabs>
				</Content>
...
export default connect(null, mapDispatchToProps)(SchoolAccommodation);
