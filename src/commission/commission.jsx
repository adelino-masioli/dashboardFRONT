...
class Commission extends Component {
	...
	render() {
		...
		return (
			<div>
				<ContentHeader>
					<ContentHeaderTitle title={nameSchool} small='Commissions'/>
					<ContentHeaderBreadcrumb>
						<ContentHeaderBreadcrumbItem path='#/' icon='home' label='Home'/>
						<ContentHeaderBreadcrumbItem active='active'  label={`${nameSchool} Commissions`}/>
					</ContentHeaderBreadcrumb>
				</ContentHeader>
					...
					<Tabs>
						...
						<TabsContent>
							<TabContent id='tabCreate'>
								<CommissionForm onSubmit={this.props.create} submitClass='primary' submitLabel='Create' dataProps={params.schoolid}/>
							</TabContent>
							<TabContent id='tabUpdate'>
								<CommissionForm onSubmit={this.props.update} submitClass='info' submitLabel='Update' dataProps={params.schoolid} dataPropsId={params.id}/>
							</TabContent>
							<TabContent id='tabDelete'>
								<CommissionForm onSubmit={this.props.remove}  readOnly={true} submitClass='danger' submitLabel='Destroy' dataProps={params.schoolid} dataPropsId={params.id}/>
							</TabContent>
						</TabsContent>
					</Tabs>
				</Content>
