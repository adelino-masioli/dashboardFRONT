...
import SchoolcontentForm from './schoolcontentForm';

import {
	create,
	update,
	remove
} from './schoolcontentActions';
...
class SchoolContent extends Component {
	...
	render() {
		...
		return (
			<div>
				<ContentHeader>
					<ContentHeaderTitle title={nameSchool} small='Content'/>
					<ContentHeaderBreadcrumb>
						<ContentHeaderBreadcrumbItem path='#/' icon='home' label='Home'/>
						<ContentHeaderBreadcrumbItem active='active'  label={`${nameSchool} Content`}/>
					</ContentHeaderBreadcrumb>
				</ContentHeader>
					...
					<Tabs>
						...
						<TabsContent>
							<TabContent id='tabCreate'>
								<SchoolcontentForm onSubmit={this.props.create} submitClass='primary' submitLabel='Create' dataProps={params.schoolid}/>
							</TabContent>
							<TabContent id='tabUpdate'>
								<SchoolcontentForm onSubmit={this.props.update} submitClass='info' submitLabel='Update' dataProps={params.schoolid} dataPropsId={params.id}/>
							</TabContent>
							<TabContent id='tabDelete'>
								<SchoolcontentForm onSubmit={this.props.remove}  readOnly={true} submitClass='danger' submitLabel='Destroy' dataProps={params.schoolid} dataPropsId={params.id}/>
							</TabContent>
						</TabsContent>
					</Tabs>
				</Content>
...
export default connect(null, mapDispatchToProps)(SchoolContent);
