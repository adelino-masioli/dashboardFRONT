...
import { init } from './agencyActions';
			...
			<form role='form' onSubmit={handleSubmit}>
				<div className='box-body'>
					<Row>
						...
						<Field name='tel' component={LabelAndInput} label='Tel' cols='12 4' placeholder='Tel' readOnly={readOnly} />
						<Field name='tel_emergency' component={LabelAndInput} label='Tel Emergency' cols='12 4' placeholder='Tel Emergency' readOnly={readOnly} />
						<Field name='tel_fax' component={LabelAndInput} label='Tel Fax' cols='12 4' placeholder='Tel Fax' readOnly={readOnly} />
...
AgencyForm = reduxForm({form: 'agencyForm', destroyOnUnmount: false})(AgencyForm);
const mapStateToProps = state => ({
	listCountries: state.country.list, 
	listZones: state.zone.listZones, 
	listCities: state.city.listCities
});
const mapDispatchToProps = dispatch => bindActionCreators({init, getListCountries, getListZones, getListCities}, dispatch);
